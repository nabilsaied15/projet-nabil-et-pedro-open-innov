...
"[project]/src/app/admin/offres/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminOffresPage() {
    ...
    const handleEditSave = async ()=>{
        ...
        setError("");
        setMessage("");
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('offres').update(editData).eq('id', editId);
        if (error) {
    ...
    const handleDelete = async (id)=>{
        ...
        setError("");
        setMessage("");
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('offres').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__078e3c17._.js.map