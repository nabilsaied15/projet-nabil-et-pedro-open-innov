...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fa$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-icons/fa/index.mjs [app-client] (ecmascript)"); // Assurez-vous d'avoir react-icons installé
;
...
_s(AddItemPage, "k7lgzkuotdiVBObSAm9WsFrOKWc=");
_c = AddItemPage;
var _c;
...
"[project]/src/app/admin/cours/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CoursPage() {
    ...
    const fetchCourses = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cours').select('*').order('created_at', {
            ascending: false
        });
    ...
    const handleCourseChange = async (id, field, value)=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cours').update({
                [field]: value
            }).eq('id', id).select();
            if (error) throw error;
    ...
    const handleDeleteCourse = async (id)=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cours').delete().eq('id', id).select();
            if (error) throw error;
...
_s(CoursPage, "6Cy98FOoU0xpS9f8sJ9enW2ibcc=", false, function() {
    return [
...
//# sourceMappingURL=src_3c31dec1._.js.map