...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            ...
            const { error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').insert([
                {
                    id: authData.user.id,
                    name: formData.name,
                    email: formData.email,
...
_s(RegisterPage, "B2pOxe/dYwWl2CAZ/m91SZE/woM=", false, function() {
    return [
...
//# sourceMappingURL=src_7de6fca6._.js.map